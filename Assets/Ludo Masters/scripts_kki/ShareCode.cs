...
public class ShareCode : MonoBehaviour
{
    ...
    {
        print("privateRoomID == " + GameManager.Instance.privateRoomID);
        str = "Hi 😃! I want to play LUDO Earn Game with you. The Room Code is " + GameManager.Instance.privateRoomID;
